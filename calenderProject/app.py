...
def index(month=None, year=None,username=None):
    ...
    print("year --------------------------",year)
    print("calendar_rows ---------------line 145-----------",calendar_rows)
    ...
    for row in events:
        ...
        if date in event_data:
            ...
            event_data[date] = [event]
    print(" 164 event_data--Type-------------::", event_data)
...
"2023-1-12": ["bdfgh"],}
    ...
    return render_template('Qaccessed.html',username=username, calendar_rows=calendar_rows,first_name= event_data)
####       username passato 


@app.route('/addevent', methods=['POST'])
def add_event():
    print("line92  sono in POST /addevent:")
